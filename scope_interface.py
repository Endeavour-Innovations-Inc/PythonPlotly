...
def get_samples():
    ...
    return samples, samples_bin

def extract_data_and_write_to_csv():
    # Call the get_samples function
    samples, samples_bin = get_samples()

    # Generate time data for the samples
    t_data = np.arange(0, len(samples), 1)
    ...
    print("Data extraction complete and written to output.csv")

# Call the function to execute the process
# extract_data_and_write_to_csv()
